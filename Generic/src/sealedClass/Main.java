...
class UserRepository implements Repository<User, Integer>{
    private final List<User> users = new ArrayList<>(List.of(new User(1, UUID.randomUUID().toString(),"koko"),
...
sealed class Service permits ServiceImpl, Util{
    public  void get(){}
}
final class ServiceImpl extends Service{ }
final class Util extends Service{}
...
public class Main {
    public static void main(String[] args) {
        ...
        userRepository.save(new User(3,UUID.randomUUID().toString(), "JAME"));
        userRepository.getAllUsers().forEach(System.out::println);
    }
}
